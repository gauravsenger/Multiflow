...
const TPV = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    country: '',
    zipcode: '',
    beneficiaryAccount: '919013353419388',
    ifscCode: 'UTIB9992478',
    udf1: '',
    udf2: '',
    udf3: '',
    udf4: '',
    ...
    paymentMethods: { upi: false, nb: false }
  })
  ...
  const validateForm = () => {
    ...
    if (!formData.beneficiaryAccount || !formData.ifscCode) {
      alert('Please enter beneficiary account and IFSC code')
      return false
    }
    return true
  }
  ...
  const handleSubmit = (e) => {
    ...
    const beneficiaryDetail = `${formData.beneficiaryAccount}|${formData.ifscCode}`
    ...
    const fields = [
      ...
      { name: 'api_version', value: '6' },
      { name: 'beneficiarydetail', value: beneficiaryDetail }
    ]
  ...
  return (
    <>
      ...
      <div className="main-content">
          ...
          <div className="form-group">
            ...
            <div className="payment-methods">
              <div className="payment-method">
                <input type="checkbox" id="tpv_upi" name="paymentMethod_upi" checked={formData.paymentMethods.upi} onChange={handleChange} />
                <label htmlFor="tpv_upi">UPI</label>
              </div>
              <div className="payment-method">
                <input type="checkbox" id="tpv_nb" name="paymentMethod_nb" checked={formData.paymentMethods.nb} onChange={handleChange} />
                <label htmlFor="tpv_nb">Net Banking</label>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="john@example.com" required className={errors.email ? 'error' : ''} />
              {errors.email && <div className="error-message">{errors.email}</div>}
            </div>
            <div className="form-group">
              <label>Phone (10 digits) <span className="required">*</span></label>
              <input type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="9999999999" required maxLength="10" className={errors.phone ? 'error' : ''} />
        ...
        <div className="section">
          <h2 className="section-title">Beneficiary Details (TPV Validation)</h2>
          ...
          <div className="form-row">
            <div className="form-group">
              <label>Beneficiary Account Number(s) <span className="required">*</span></label>
              <input type="text" name="beneficiaryAccount" value={formData.beneficiaryAccount} onChange={handleChange} placeholder="919013353419388" required />
              <small style={{ color: 'var(--text-tertiary)' }}>For multiple accounts, separate with pipe (|) - Max 4 accounts</small>
            </div>
            <div className="form-group">
              <label>IFSC Code(s) <span className="required">*</span></label>
              <input type="text" name="ifscCode" value={formData.ifscCode} onChange={handleChange} placeholder="UTIB9992478" required />
        ...
        <div className="section">
          <h2 className="section-title">TPV Configuration</h2>
          <div className="form-group">
            <label>API Version <span className="required">*</span></label>
            <input type="text" value="6" readOnly style={{ backgroundColor: '#f5f5f5', cursor: 'not-allowed' }} />
            <small style={{ color: 'var(--text-tertiary)', display: 'block', marginTop: '0.25rem' }}>Mandatory for TPV payments (always 6)</small>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="alert alert-info">
            <strong>UDF Information:</strong> All UDF fields are optional for TPV transactions.
          </div>
          <div className="form-row">
            <div className="form-group">
