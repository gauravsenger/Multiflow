...
const PreAuth = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'phone') {
      ...
      if (phoneValidation.value !== value) e.target.value = phoneValidation.value
    } else if (name === 'email') {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.paymentMethods.cc) fields.push({ name: 'enforce_paymethod', value: 'creditcard' })
    ...
    <>
      ...
      <div className="main-content">
        <div className="section">
          ...
          <div className="form-group">
            <label>Enforce Payment Methods <span className="required">*</span></label>
            <div className="payment-methods">
              <div className="payment-method">
                <input type="checkbox" id="preauth_cc" name="paymentMethod_cc" checked={formData.paymentMethods.cc} onChange={handleChange} />
                <label htmlFor="preauth_cc">Credit Cards</label>
              </div>
            </div>
          </div>
          ...
          <div className="form-group" style={{ marginTop: '1rem' }}>
            ...
            <small style={{ color: 'var(--text-tertiary)', display: 'block', marginTop: '0.25rem' }}>Mandatory for PreAuth flow (always 1)</small>
          </div>
        </div>
